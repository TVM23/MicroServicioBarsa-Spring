...
public class BaseKafkaListener {
	...
	public <T> void processKafkaMessage(String message, String responseTopic,
			Function<Map<String, Object>, T> serviceCall) {
		try {
			...
			/*
			 * Object responseBody; if (data instanceof ResponseEntity) { responseBody =
			 * ((ResponseEntity<?>) data).getBody(); // ✅ solo mandamos el .body } else {
			 * responseBody = data; }
			 */
